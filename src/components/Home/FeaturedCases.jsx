  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between p-8 md:p-16 bg-white text-black">
      <div className="space-y-4 md:max-w-xl">
        <h2 className="text-3xl md:text-4xl font-semibold uppercase">evolving digital</h2>
        <p className="text-2xl md:text-3xl font-bold uppercase">transmission landscape</p>
